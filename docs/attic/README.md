...
## The v0.9-v0.26 continuous-learning loop

v0.9.0 through v0.26.0 layered an agent-memory loop on top of the
...
v0.27.0 removed all of it — learning belongs to a Claude Code plugin,
not to an isolation tool. Pin **v0.26.0** for the working
implementation; [docs/MIGRATION-v0.26-to-v0.27.md](../MIGRATION-v0.26-to-v0.27.md)
...
superseded it wholesale, and v0.27.0 then retired its successor too.
...
- [INSTINCTS.md](INSTINCTS.md) — the v0.5-v0.8 instinct subsystem (`memory_backends:` config, `bough instinct mint/approve/promote/query/forget`). The v0.9-v0.26 `bough instinct status/list/show/promote` shared the `promote` name but was a different command over a different data model.
